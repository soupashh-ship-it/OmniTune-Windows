...
import com.omnitune.innertube.models.AccountInfo
...
import com.omnitune.innertube.models.GridRenderer
import com.omnitune.innertube.models.MediaInfo
import com.omnitune.innertube.models.MusicResponsiveListItemRenderer
import com.omnitune.innertube.models.MusicTwoRowItemRenderer
import com.omnitune.innertube.models.MusicCarouselShelfRenderer
import com.omnitune.innertube.models.MusicShelfRenderer
import com.omnitune.innertube.models.PlaylistItem
import com.omnitune.innertube.models.SearchSuggestions
import com.omnitune.innertube.models.Run
import com.omnitune.innertube.models.Runs
...
import com.omnitune.innertube.models.response.AccountMenuResponse
import com.omnitune.innertube.models.response.BrowseResponse
import com.omnitune.innertube.models.response.CreatePlaylistResponse
import com.omnitune.innertube.models.response.GetQueueResponse
import com.omnitune.innertube.models.response.GetSearchSuggestionsResponse
import com.omnitune.innertube.models.response.GetTranscriptResponse
...
import com.omnitune.innertube.pages.ArtistItemsContinuationPage
import com.omnitune.innertube.pages.ArtistItemsPage
...
import com.omnitune.innertube.pages.HistoryPage
import com.omnitune.innertube.pages.HomePage
import com.omnitune.innertube.pages.LibraryContinuationPage
import com.omnitune.innertube.pages.LibraryPage
import com.omnitune.innertube.pages.MoodAndGenres
import com.omnitune.innertube.pages.NewReleaseAlbumPage
import com.omnitune.innertube.pages.NextPage
import com.omnitune.innertube.pages.NextResult
import com.omnitune.innertube.pages.PlaylistContinuationPage
import com.omnitune.innertube.pages.PlaylistPage
import com.omnitune.innertube.pages.RelatedPage
import com.omnitune.innertube.pages.SearchPage
import com.omnitune.innertube.pages.SearchResult
import com.omnitune.innertube.pages.SearchSuggestionPage
...
object YouTube {
    ...
    suspend fun albumSongs(playlistId: String, album: AlbumItem? = null): Result<List<SongItem>> = runCatching {
        ...
        val shelfContents = response.contents?.twoColumnBrowseResultsRenderer
    ...
    suspend fun player(
        ...
        if (resolvedPoToken == null && PlaybackAuthState.needsServiceIntegrity(client)) {
              resolvedPoToken = com.omnitune.innertube.utils.PoTokenGenerator.generateContentToken(
    ...
    suspend fun next(endpoint: WatchEndpoint, continuation: String? = null): Result<NextResult> = runCatching {
        ...
        val playlistPanelRenderer = response.continuationContents?.playlistPanelContinuation
            ...
            ?: throw IllegalStateException("Missing playlist panel for next response")
