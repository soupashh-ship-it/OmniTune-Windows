...
The current desktop package version in Gradle is `0.1.3`.
...
- [OmniTune Windows 0.1.3 RC 1](https://github.com/soupashh-ship-it/OmniTune-Windows/releases/tag/v0.1.3-rc.1)

Download `OmniTune-Setup-0.1.3-windows-x64.exe` from that release for installer testing. The installer is unsigned, so Windows SmartScreen may warn until a signing certificate and reputation are established.
